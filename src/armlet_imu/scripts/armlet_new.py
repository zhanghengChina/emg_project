...
if __name__ == '__main__':
    ...
    for i in range(2):
        queue_cache.append(mp.Queue())
    show = Show(queue_cache[0], queue_cache[1], event_cache[1], val, arr)
    upper_imu = IMU_Read(0.75, event_cache[0], queue_cache[0], val,  '/dev/rfcomm0', 460800)
    lower_imu = IMU_Read(0.55, event_cache[0], queue_cache[1], val,  '/dev/rfcomm1', 460800)
