#这个python文件的内容还是挺重要的，作用是通过tcpip返回的数据来读取UR的数据，只要将其打包成一个node，其实就可以将数据发送出来
#源文件的网址是：https://www.universal-robots.com/how-tos-and-faqs/how-to/ur-how-tos/remote-control-via-tcpip-16496/
#!/usr/bin/env python
import socket
import time
import struct
